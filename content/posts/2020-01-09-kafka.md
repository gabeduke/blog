...
This example deploys a Kafka cluster using [Banzai Cloud Kafka Operator](https://github.com/banzaicloud/kafka-operator). This guide is a condensed version of the official Banzai documentation, the idea is to quickly get up and running and explore their offering.

## Setup

_Prerequisites_:

- Civo CLI and access to the Beta program (Not strictly necessary but it is _FAST_)
- Helm3
- Kubectl
